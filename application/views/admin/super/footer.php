    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <!--<div class="col-xs-6 col-md-4 col-lg-1 ">
                <a href='http://gridet.com' onclick='function go(ev) { ev.preventDefault(); var win = window.open("http://manual.limesurvey.org", "_blank"); win.focus(); }; go(event);'>
            ...
            <div  class="col-xs-6 col-md-4  col-lg-5 text-right"  >
                <a href='http://gridet.com' target="_blank">
                    <img alt='welcome to visit our website, www.gridet.com!' title='welcome to visit our website, www.gridet.com!' src='<?php echo Yii::app()->getConfig('adminimageurl');?>donate.png'/>
                </a>
            </div>

            <!-- Lime survey website -->
            <!--<div class="col-xs-6 col-md-4 col-lg-6 text-right">
                <a  title='<?php eT("Visit our website!"); ?>' href='http://www.gridet.com' target='_blank'>LimeSurvey</a><br /><?php echo $versiontitle."  ".$versionnumber.$buildtext;?>
            </div>-->
        </div>
    </div>
</footer>
